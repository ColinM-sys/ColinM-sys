...
AI/ML Developer | Security Researcher | Open Source Contributor | Maritime SIGINT
...
- Badge reverse-engineering: RE'd DC34 badge LED control protocol (80ms/byte, bio tx protocol) from Jetson
- SAO challenge: Reverse-engineered SAO LED driver I2C registers for color-change exploit

**Maritime Hacking Village CTF** (Aug 8–10, 2026)  
2,330 points / 19 solves. ELF source located but time-constrained. Crane WiFi client isolation bypassed via /32 gateway routes. Built autonomous Pi watchdog banked the queue through connectivity hell.

**WordPress AI Contributor Day** (Aug 2026)  
...
- **Maritime Hacking Village CTF** (Aug 8–10) — 5th place overall (solo) / 2,330 pts / 19 solves in 24 hours
...
🏆 **Maritime Hacking Village CTF 2026** — 5th place overall (solo) / 2,330 pts / 19 solves in 24 hours

---

## 🔒 Security Research

**60+ Confirmed Findings** — NVIDIA PSIRT  
Across NeMo Agent Toolkit, NemoClaw, NeMo Guardrails. CVE-2026-24222 (CVSS 8.6 High) published in NVIDIA Security Bulletin.

**Samsung PSIRT** — Zero-auth DLNA injection + RCE chains

**Maritime Systems** — Vessel management system vulnerabilities under coordinated disclosure

**Blockchain Forensics** — ~$3B Iranian sanctions-evasion network on Tron (5 exchanges, multi-hop fingerprinting)
